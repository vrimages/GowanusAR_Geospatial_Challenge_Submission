...
namespace Gaskellgames.InputEventSystem
{
    public class VRInputController : MonoBehaviour
    {
        ...
        [SerializeField, ReadOnly] private VRInputs leftHand;
        [SerializeField, ReadOnly] private VRInputs rightHand;
        ...
        public VRInputs GetLeftHandInputs()
        {
            return leftHand;
        }

        public VRInputs GetRightHandInputs()
        {
            return rightHand;
        }
