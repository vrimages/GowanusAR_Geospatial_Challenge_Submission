...
{
    /// <summary>
    /// ModularTextEditorWindow.cs replaces this.
    /// </summary>
    public class AssetWindow : EditorWindow
    {
        ...
        {
            GUILayout.Space(20);
            GUILayout.Label("Please use the redesign for font creation. It can be found in Tools/Tiny Giant Studio/Redesign.\nEverything will be slowly moved to the redesign made using UI Toolkit.", EditorStyles.centeredGreyMiniLabel);
            GUILayout.Space(10);

            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            if (GUILayout.Button("Open the redesign", buttonStyle, GUILayout.MaxWidth(150), GUILayout.MaxHeight(30)))
            {
                ModularTextEditorWindow.ShowWindow();
            }
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
        }
        ...
        private void TextPreference()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showDefaultTextSettings.faded))
            {
                ...
                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultTextMaterial"), settings.defaultTextMaterial, "Text Material");
        ...
        private void ButtonPreference()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showDefaultButtonSettings.faded))
            {
                ...
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultButtonNormalTextMaterial"), settings.defaultButtonNormalTextMaterial, "Text Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                    ApplyDefaultButtonNormalTextMaterialToScene();
                EditorGUILayout.EndHorizontal();

                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultButtonNormalBackgroundMaterial"), settings.defaultButtonNormalBackgroundMaterial, "Background Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                ...
                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultButtonSelectedTextMaterial"), settings.defaultButtonSelectedTextMaterial, "Text Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                    ApplyDefaultButtonSelectedTextMaterialToScene();

                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultButtonSelectedBackgroundMaterial"), settings.defaultButtonSelectedBackgroundMaterial, "Backgroud Material");
                ...
                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultButtonPressedTextMaterial"), settings.defaultButtonPressedTextMaterial, "Text Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                    ApplyDefaultButtonPressedTextMaterialToScene();

                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultButtonPressedBackgroundMaterial"), settings.defaultButtonPressedBackgroundMaterial, "Backgroud Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                ...
                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultButtonDisabledTextMaterial"), settings.defaultButtonDisabledTextMaterial, "Text Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                    ApplyDefaultButtonDisabledTextMaterialToScene();

                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultButtonDisabledBackgroundMaterial"), settings.defaultButtonDisabledBackgroundMaterial, "Background Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
        ...
        private void ListPreference()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showDefaultListSettings.faded))
            {
                ...
                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultListNormalTextMaterial"), settings.defaultListNormalTextMaterial, "Text Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                    ApplyDefaultListNormalTextMaterialToScene();

                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultListNormalBackgroundMaterial"), settings.defaultListNormalBackgroundMaterial, "Background Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                ...
                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultListSelectedTextMaterial"), settings.defaultListSelectedTextMaterial, "Text Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                    ApplyDefaultListSelectedTextMaterialToScene();

                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultListSelectedBackgroundMaterial"), settings.defaultListSelectedBackgroundMaterial, "Background Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                ...
                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultListPressedTextMaterial"), settings.defaultListPressedTextMaterial, "Text Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                    ApplyDefaultListPressedTextMaterialToScene();

                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultListPressedBackgroundMaterial"), settings.defaultListPressedBackgroundMaterial, "Background Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                ...
                EditorGUILayout.BeginHorizontal();
                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultListDisabledTextMaterial"), settings.defaultListDisabledTextMaterial, "Text Material");
                if (GUILayout.Button("Apply", GUILayout.MaxWidth(50)))
                    ApplyDefaultListDisabledTextMaterialToScene();

                MText_Editor_Methods.PreviewField(soTarget.FindProperty("defaultListDisabledBackgroundMaterial"), settings.defaultListDisabledBackgroundMaterial, "Background Material");
        ...
        private void MeshSettings()
        {
            ...
            if (settings.vertexDensity > 4)
            {
                EditorGUILayout.HelpBox("Please note that a high vertex density will increase font creation time." +
                    ...
                    "\nIncreasing it too much might break the font and give weird result." +
                    "\nIn those cases, please recreate the font with lower vertex density.", MessageType.Warning);
            }
            GUILayout.EndVertical();
        }
