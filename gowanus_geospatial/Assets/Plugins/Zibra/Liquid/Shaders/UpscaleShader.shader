Shader "Hidden/ZibraEffects/Liquid/UpscaleShader"
{
    SubShader
    {
        Pass
        {
            ...
            Texture2D<float> ShadedLiquidDepth;
            SamplerState samplerShadedLiquidDepth;
            ...
            PSOut PSMain(VSOut input)
            {
                ...
                output.depth = ShadedLiquidDepth.Sample(samplerShadedLiquidDepth, input.uv * TextureScale);
