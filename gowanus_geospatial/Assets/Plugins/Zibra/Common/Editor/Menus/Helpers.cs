...
namespace com.zibra.common.Editor.Menus
{
    internal static class Helpers
    {
        ...
        class DiagInfo
        {
            ...
            public bool LiquidAvailable = PluginManager.IsAvailable(PluginManager.Effect.Liquid);
            public bool SmokeAvailable = PluginManager.IsAvailable(PluginManager.Effect.Smoke);
